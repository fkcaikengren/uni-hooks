...
Defined in: [packages/uni-hooks/src/useBoolean/index.ts:27](https://github.com/fkcaikengren/uni-hooks/blob/main/packages/uni-hooks/src/useBoolean/index.ts#L27)
