...
Defined in: [packages/uni-hooks/src/onPageHide/index.ts:26](https://github.com/fkcaikengren/uni-hooks/blob/main/packages/uni-hooks/src/onPageHide/index.ts#L26)
