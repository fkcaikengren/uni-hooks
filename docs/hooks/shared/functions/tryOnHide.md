...
Defined in: [packages/uni-hooks-shared/src/tryOnHide/index.ts:32](https://github.com/fkcaikengren/uni-hooks/blob/main/packages/uni-hooks-shared/src/tryOnHide/index.ts#L32)
