...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@caikengren/uni-hooks': resolve(import.meta.dirname, 'packages/hooks/index.ts'),
      '@caikengren/uni-hooks-shared': resolve(import.meta.dirname, 'packages/shared/index.ts'),
      '@caikengren/uni-use-request': resolve(import.meta.dirname, 'packages/use-request/index.ts'),
    },
    dedupe: [
      'vue',
      '@vue/runtime-core',
